...
public class SecureQR implements Communicator{
    ...
    static public final String FAIL_DECRYPT = "복호화 실패";
    static public final String FAIL_INDEX = "인덱스 오류";
    static public final String FAIL_DATA = "원본 데이터와 다름";
    static public final String FAIL_HASH = "해시 값이 다름";
